...
export function Header() {
  ...
  return <header className="site-header"><div className="shell header-inner"><Brand/><button className="menu-button" aria-label="Toggle menu" aria-expanded={open} onClick={() => setOpen(!open)}><span/><span/><span/></button><nav className={open ? "nav open" : "nav"}><Link href="/category/torque-specs">Specifications</Link><Link href="/makes/chevrolet">Makes</Link><Link href="/about">About</Link></nav></div></header>;
}

export function Footer() {
  return <><section className="assurance"><div className="shell assurance-grid"><div><span className="trust-symbol">✓</span><p><strong>Accurate. Verified.</strong><br/>Built for careful work.</p></div><div><span className="trust-symbol">▤</span><p><strong>Thousands of specs.</strong><br/>All in one place.</p></div><div><span className="trust-symbol">◷</span><p><strong>Save time.</strong><br/>Do the job right.</p></div></div></section><footer><div className="shell footer-inner"><p>© 2026 TorqueSheet Mechanical Reference</p><nav><Link href="/about">About</Link><Link href="/contact">Contact</Link><Link href="/privacy">Privacy Policy</Link><Link href="/terms">Terms of Use</Link></nav></div></footer></>;
}
