...
// Search-result pages carry no unique value for the index and ?q= is an
// unbounded parameter space, so this route is noindex,follow and stays out of
// the sitemap.
export const metadata = {
  ...pageMetadata({ title: "Search Vehicle Specifications", description: "Search TorqueSheet by vehicle make, model, engine, torque specification, firing order, fluid capacity, or diagram type.", path: "/search" }),
