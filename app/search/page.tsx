...
export const metadata = pageMetadata({ title: "Search Vehicle Specifications", description: "Search TorqueSheet by vehicle make, model, engine, torque specification, firing order, fluid capacity, or diagram type.", path: "/search" });
